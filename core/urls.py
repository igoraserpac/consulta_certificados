...
urlpatterns = [
    ...
    path('vencimento-pdf/<str:primeiro>_<str:ultimo>', relatorio_vencimentos, name='relatorio_vencimentos'),
    ...
    path('transferir-certificados/', TransferirCertificadosView.as_view(), name='transferir_certificados'),
    path('excluir/<slug:pk>', Pos.as_view(), name='pos_transferencia'),
]
